...
import shippingGatewayRoutes from "./admin/shippingGateway.routes.js";
import shipmentRoutes from "./admin/shipment.routes.js";
import shippingPublicRoutes from "../shipping/routes.js";
...
import userPermissionRoutes from "./admin/userPermission.routes.js";
...
router.use("/admin/shipping-gateways", shippingGatewayRoutes);
router.use("/admin/shipments", shipmentRoutes);
...
router.use("/admin/user-permissions", userPermissionRoutes);
