...
// NOTE: /return/:sessionId and /webhook/:gatewayName no longer need a
// route-level CORS override here — the actual origin-allowlist middleware
// (mounted in the root server file) now exempts these two paths directly,
// which is the correct place to fix it (a route-level header here can't undo
// an earlier `cors()` middleware that already rejected the request).
